...
${filterList}       <li><a onclick="openModal('advSearchByColor'); w3_close()">6. By color</a></li>
            <li><a onclick="openModal('advSearch7'); w3_close()">7. Supplier + PO</a></li>
            <li><a onclick="openModal('advSearch8'); w3_close()">8. Supplier + PO + AuthContact</a></li>
            <li><a onclick="openModal('advSearch9'); w3_close()">9. Supplier + Status not blank</a></li>
        </ul>
        <!-- ============================ MainManu ========================================================================= -->
        <ul>
            ${commentOnMenu1}<li><a href="/View/ID/gte/0/OrderBy"><i class="fa fa-home${menu1}"></i></a></li>${commentOffMenu1}
