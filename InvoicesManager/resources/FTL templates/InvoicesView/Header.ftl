...
<!-- ============================ SideNav ========================================================================== -->
        <ul class="IM-sidenav">
            ...
            <li><a href="/IFV/User/eq/${NetID}/PO/neq/null/AuthEmail/eq/null/GR/ASC/1">NetID + PO nr only + AuthEmail blank</a></li>
            ...
            <li><a onclick="openModal('advSearch10'); w3_close()">Supplier + GR blank</a></li>
        </ul>
        <!-- ============================ MainManu ========================================================================= -->
        <ul>
...
<!-- ================================ Modal Structure for Advance Search Supplier + GR blank =============== -->
        <div id="advSearch10" class="modal" style="border: 1px solid #bbb">
            <div class="modal-content white" style="height: auto">
                <h5 style="text-align: center">Advance Search Supplier + GR blank</h5>
                <form method="post">
                    <div class="row center">
                        <div class="col s4">
                            <input placeholder="search column" id="search_query_columns" name="search_query_columns" type="text" value="Supplier">
                    ...
                    <div class="row center">
                        <div class="col s4">
                            <input placeholder="search column2" id="search_query_columns2" list="columns" name="search_query_columns2" type="text" value="GR">
                        </div>
                        <div class="col s1 center">
                            <input id="search_query_sign2" list="signs" name="search_query_sign2" type="text" value="=">
                        </div>
            ...
            <div class="modal-fixed-footer blue">
                <a onclick="closeModal('advSearch10');" class="modal-close">
                    <h5 style="padding: 8px;border: 1px solid #2196F3;margin: 10px 0 0 0;">Close</h5>
                </a>
            </div>
        </div>
